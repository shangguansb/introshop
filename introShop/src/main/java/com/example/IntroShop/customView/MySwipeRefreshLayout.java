...
public class MySwipeRefreshLayout extends ViewGroup {
    ...
    private MySwipeProgressBar mProgressBar; //the thing that shows progress is going
    private MySwipeProgressBar mProgressBarBottom;
...
//            }
    ...
    public MySwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        mProgressBar = new MySwipeProgressBar(this);
        mProgressBarBottom = new MySwipeProgressBar(this);
...
//                final float yDiff = y - mInitialMotionY;
                ...
                if (mIsBeingDragged) {
                    // _User velocity passed min velocity; trigger a refresh
                    if (yDiff > mDistanceToTriggerSync) {
                        // _User movement passed distance; trigger a refresh
